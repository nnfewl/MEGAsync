...
source=("megasync-official-${_upstream_ver}-${_upstream_rel}-x86_64.pkg.tar.zst::https://mega.nz/linux/repo/Arch_Extra/x86_64/megasync-${_upstream_ver}-${_upstream_rel}-x86_64.pkg.tar.zst"
